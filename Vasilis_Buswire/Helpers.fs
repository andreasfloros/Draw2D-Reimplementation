...
// let distFromPoint (point: XYPos) (box: BB) returns float

// let containsPoint (box: BB) (point: XYPos) returns bool
...
let containsPoint (boundingBox: BB) (point: XYPos) = 
    let topLeftCondition1 = (point.X > boundingBox.TopLeft.X) && (point.Y > boundingBox.TopLeft.Y)
    let bottomRightCondition1 = (point.X < boundingBox.BottomRight.X) && (point.Y < boundingBox.BottomRight.Y)
    let validScenario1 = topLeftCondition1 && bottomRightCondition1

    let topLeftCondition2 = (point.X > boundingBox.TopLeft.X) && (point.Y < boundingBox.TopLeft.Y)
    let bottomRightCondition2 = (point.X < boundingBox.BottomRight.X) && (point.Y > boundingBox.BottomRight.Y)
    let validScenario2 = topLeftCondition2 && bottomRightCondition2

    validScenario1 || validScenario2