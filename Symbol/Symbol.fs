...
let generateCompWithUpwardInputs compType compId compPos =
    ...
    let inPortList = generatePortList compProps numOfRightInputs PortType.Input Right 
    let selectPortList = generatePortList compProps numOfUpwardInputs PortType.Input Up 
    let outPortList = generatePortList compProps numOfOutputs PortType.Output Left   
